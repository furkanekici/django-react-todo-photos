...
function Layout() {
    ...
    return (
        <div data-theme={darkMode ? "forest" : "garden"} className="drawer">
            ...
            <div className="drawer-content flex flex-col">
                <div className="w-full navbar ">
                    ...
                    <div className="flex-1 font-medium ml-2 leading-tight text-l">Todo Application</div>
